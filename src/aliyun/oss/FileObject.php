...
namespace innln\oss\aliyun\oss;

use innln\oss\FileObjectInterface;
use innln\comm\core\BaseObject;
use OSS\OssClient;
use OSS\Core\OssUtil as AliyunOssUtil;
/**
 * 文件对象管理
 */
class FileObject extends BaseObject implements FileObjectInterface
{
    /**
     * @var AliyunOssConfigure
     */
    public AliyunOssConfigure $configure;
